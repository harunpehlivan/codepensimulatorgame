...
$('body').on('click', '.share', () => {
    twShare(`https://codepen.io/harunpehlivan`, `I managed to get ${developer.followers.toLocaleString()} followers on the Codepen Simulator Game by @harunpehlivan. https://codepensimulatorgame.harunpehlivanitdew.repl.co/ %23codepenSimGame`, 520, 350);
    return false;
});
